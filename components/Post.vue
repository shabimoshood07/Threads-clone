            ...
            <div class="flex items-center">
                <div class="flex items-center flex-wrap text-white gap-1 w-[42px]">
                    <div class="flex gap-0.5">
                        <img src="https://picsum.photos/id/202/50" class="rounded-full h-[14px] mt-2" alt="">
                        <img src="https://picsum.photos/id/223/50" class="rounded-full h-[17px]" alt="">
                    </div>
                    <div class="flex items-center">
                        <img src="https://picsum.photos/id/99/50" class="rounded-full h-[11px] ml-4" alt="">
                    </div>
                </div>
            </div>
        </div>
